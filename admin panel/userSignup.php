    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <button type="button" style='padding-top:1%; padding-right:1%;' class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          
		<h4 class="modal-title well text-primary" id="myModalLabel"><center>sign up to enjoy our services</center></h4>
        </div>
