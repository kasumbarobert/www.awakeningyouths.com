...
if(isset($_POST["event_title"]))
{
	...
	$insert_event=mysql_query("INSERT INTO events(event_id,event_title,venue,event_description,due_date,due_time) VALUES('$event_id','$title','$venue','$description','$date_due','$time_due')");
	...
	if($insert_event)
	{
		...
		$path2="images/".basename($_FILES["event_photo"]["name"]);
		...
		$insert_picture=mysql_query("INSERT INTO pictorials(Image_Name,event_id,date_uploaded, caption) VALUES('$path2','$event_id','CURDATE()','$caption')") or die(mysql_error());
