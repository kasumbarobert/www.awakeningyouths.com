...
<body>
	...
	<div class='row'>
	<div class='col-lg-9' style='padding:1%;'>
	<?php
		...
		if(isset($_GET['$^CRGRBN*HBNYYN']))
		{
			echo
			"
			<div class='thumbnail well' style='padding:2%; '>";
			echo "<center class='text-info well text-primary' style='background-color:white; height:auto; padding:1%; '><h3 class='text-primary'>".$_GET['5672ghjathblkksjbsysjvsghaja']."</h3></center>
		...
		else
		{
			...
			require_once("connector.php");
					 ...
					 if($get_pics)
					 {
						 ...
						 <div class='row' style='padding:2%; margin-right:2%;'>";
