...
<div class="col-lg-2 col-sm-2 col-md-2 list-group " style="margin-top:2%;">
				...
				<button class="list-group-item " id="lowerMenuToggle" style="border:hidden; color:black; background-color:transparent; margin-top:1%;">More <i class='fa fa-reorder (alias)'></i> </button>
