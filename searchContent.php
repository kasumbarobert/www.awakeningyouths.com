			...
			<?php
				if(isset($_POST['search_key']))
				{
					...
					if( $check_events && mysql_num_rows($check_events))
					{
						...
						echo "<h2 class='text-success'>Events that much your search <span class='badge'>$number events<span></h2>
					...
					if( $check_articles && mysql_num_rows($check_articles))
					{
						...
						echo "<h2 class='text-success'>Articles that much your search <span class='badge'>$number articles<span></h2>
						<div class='list-group'>";
					...
					if(!$matchfound)
					{
						echo "<h2 class='text-danger'>There are no results matchig the search key \"$search_key\"</h2>";
					}
